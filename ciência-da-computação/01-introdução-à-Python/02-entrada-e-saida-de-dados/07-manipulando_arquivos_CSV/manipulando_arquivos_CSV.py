...
# vantagem é que não precisamos manipular os índices para acessar os dados
# das colunas. A desvantagem é o espaço ocupado em memória (que é maior
# que o comum), devido à estrutura de dados utilizada.
